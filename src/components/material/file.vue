<template>
    <div>
        ...
        >
            <el-image class="image" v-if="type == 'image'" fit="contain" :src="normalizedUri"></el-image>
            <video class="video" v-else-if="type == 'video'" :src="normalizedUri"></video>
            <el-image
                class="image"
                v-else
...
export default defineComponent({
    ...
    computed: {
        ...
        normalizedUri() {
            return normalizeImageUrl(this.uri as string)
        }
    }
})
</script>
